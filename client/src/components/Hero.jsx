...
const Hero = () => {
    ...
    bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
            ...
            <div className='text-center mb-6'>
             ...
             font-semibold mx-auto leading-[1.2]'>Create amezing content <br /> with 
                    <span className='text-primary'> AI tools</span></h1>

                <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs
                 text-gray-600'>Transform your content creation with our suite of priemium AI tool,
                    write articles, genrate images and enhance your work flow.</p>
            </div>
